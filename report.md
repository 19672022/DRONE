...
|*3. Имитатор Центрального блока управления (CCU)* | Осуществляет полный контроль над БПЛА. Выполняет шифрование и дешифрование данных. | Доверенный. _Защита основана на системе выделенного электропитания и отдельного защищенного модуля памяти. Функционирование основано на дополнительном шифровании. |
